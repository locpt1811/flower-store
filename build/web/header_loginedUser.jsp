<%-- 
    ...
    Created on : 11-Mar-2023, 07:49:21
    Author     : Tan Loc
--%>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div  class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul>
                    ...
                    <li class="nav-item"><a href="personalPage.jsp">View Orders</a></li>
                    <% if (session.getAttribute("email").equals("admin@gmail.com")) { %>
                    <li class="nav-item"><a href="adminPage.jsp">Admin</a></li>
                        <%}%>
                    <li class="nav-item"><a href="completedOrder.jsp">Completed Orders</a></li>
                    <li class="nav-item"><a href="canceledOrder.jsp">Canceled Orders</a></li>
                    <li class="nav-item"><a href="processingOrder.jsp">Processing Orders</a></li>
